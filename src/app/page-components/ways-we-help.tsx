...
const WAYS_TO_HELP = [
  ...
  },
  {
    ...
    description:
      "A dedicated support network for the spouses and dependents of ministers, missionaries, pastors, and educators who are in need of finaincial and other forms of support.",
